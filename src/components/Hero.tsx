        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:gap-12 items-center">
          ...
          <div className="flex flex-col items-start text-left max-w-2xl">
            ...
            <motion.a
              ...
              className="mt-10 inline-flex max-w-md flex-col rounded-[24px] border border-[#00E676]/15 bg-[#00E676]/[0.02] p-6 transition duration-300 hover:border-[#00E676]/30 hover:bg-[#00E676]/[0.05]"
            >
              <div className="flex items-center gap-4">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#00E676]/10 text-[#00E676]">
                ...
                <span className="text-lg font-medium text-[#00E676]">Escríbenos por WhatsApp</span>
              </div>
